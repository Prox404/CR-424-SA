...
public class GenerateLinkQRActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_link_qractivity);
        ...
        btnGenerate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!textToEncode.isEmpty() && isURL(textToEncode)) {
                    generateQRCode(textToEncode);
                    showActionLayout.setVisibility(View.VISIBLE);
                }else{
                    Toast.makeText(GenerateLinkQRActivity.this, "Please input an URL !", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void saveQRCode() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (qrCodePath != null) {
                boolean isInserted = db.insertCreatedQR(null,scannedContent, null, null, null, null, null, null, qrCodePath);
                if (isInserted) {
