...
public class GeneratePhoneQRActivity extends BaseActivity {

    private ImageView imageViewResult;
    private EditText edtFirstName, edtLastName, edtPhoneNumber, edtOrg, edtEmail, edtAddress, edtWebsite;
    private Button btnGenerate, btnShare, btnSave;

    private String FirstName, LastName, PhoneNumber, Org, Email, Address, Website;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_phone_qractivity);
        ...
        btnGenerate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!FirstName.isEmpty() && !LastName.isEmpty() && !PhoneNumber.isEmpty()) {
                    String contact = generateContactString();
                    generateQRCode(contact);
                    showActionLayout.setVisibility(View.VISIBLE);
                } else {
                    Toast.makeText(GeneratePhoneQRActivity.this, "Please input required field !", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private String generateContactString() {
        Org = edtOrg.getText().toString().trim();
        Email = edtEmail.getText().toString().trim();
        Address = edtAddress.getText().toString().trim();
        Website = edtWebsite.getText().toString().trim();

        String contactString = "BEGIN:VCARD \nVERSION:3.0";

        if (!FirstName.isEmpty() && !LastName.isEmpty()){
            contactString += "\nN:";
            contactString += FirstName;
            contactString += ";";
            contactString += LastName;
        }
        ...
        Log.i("contactString", contactString);
    ...
    private void saveQRCode() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (qrCodePath != null) {
                boolean isInserted = db.insertCreatedQR(null,null, FirstName + LastName, Org, PhoneNumber, Address, Email, Website, qrCodePath);
                if (isInserted) {
